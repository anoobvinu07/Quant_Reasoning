...
Where, the numerator $(b-d)^2$ $<$ 0. This is mathematically stable but it needs to be checked whether they are ecologically stable.
...
curve(b*x/(x+M) - d - c*x, from = 0, to = 100, ylab = "dN/dt", xlab = "N") # N is turned into x, due to some problem with the curve()

x <- c(0,10,50) # equilibrium points
y <- c(0,0,0)
points(x,y, pch = c(1,19,19))
